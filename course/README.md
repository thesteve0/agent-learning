...
│   ├── module5-evaluation.md          # Eval harness and MLflow baseline
│   ├── module6-fastapi-integration.md # Web API integration
│   └── module7-conference-demos.md    # Advanced topics and demos
...
│   ├── module6_fastapi_integration.py # Web endpoint
│   └── module7_conference_demo.py    # Demo progression for talks
├── exercises/
...
│   └── exercise4_evaluation.md       # Build the evaluation harness
└── resources/
...
→ **[Complete guide](modules/module5-evaluation.md)** | [Exercise](exercises/exercise4_evaluation.md)

- Compound reliability formula
- Step, field, and end-to-end accuracy measurement
- Eval set creation and MLflow baseline runs

### Module 6: FastAPI Integration (1-2 hours)
→ **[Complete guide](modules/module6-fastapi-integration.md)** | [Example code](examples/module6_fastapi_integration.py)
...
→ **[Complete guide](modules/module7-conference-demos.md)** | [Example code](examples/module7_conference_demo.py)
...
**Session 3** (2-3 hours):
- Module 5: Evaluation harness + baseline
- Module 6: FastAPI integration
- **Checkpoint**: Baseline MLflow run saved, web app working end-to-end

**Session 4** (1-2 hours):
- Module 7: Advanced topics + conference demos
- **Checkpoint**: Demo progression script runs
...
**Module 5**: `python src/stardew_vision/eval/harness.py baseline` → MLflow run logged with accuracy metrics
...
**Module 7**: `python examples/module7_conference_demo.py` → All demos execute
