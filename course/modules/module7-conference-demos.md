# Module 7: Conference Demos & Advanced Topics

**Duration**: 1-2 hours
**Prerequisites**: Modules 1-6 completed
**Example Code**: [`examples/module7_conference_demo.py`](../examples/module7_conference_demo.py)
...
- Demo: `examples/module6_fastapi_integration.py`
...
python agent-learning/examples/module7_conference_demo.py
```
...
- Module 6: FastAPI (web interface) ✅
- Module 7: Advanced topics (decision-making) ✅
...
**Code**:
- Full demo script: [`examples/module7_conference_demo.py`](../examples/module7_conference_demo.py)
