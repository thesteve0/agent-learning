...
**Duration**: 1-2 hours
**Prerequisites**: Module 5 (Evaluation baseline established), FastAPI basics
**Example Code**: [`examples/module6_fastapi_integration.py`](../examples/module6_fastapi_integration.py)
...
Module 6: FastAPI routes (web interface)
...
- Module 6: FastAPI (web interface) ⬅ You are here
- Module 7: Advanced topics (decision framework, demos)
...
**Code**:
- Full example: [`examples/module6_fastapi_integration.py`](../examples/module6_fastapi_integration.py)
...
**Ready for Module 6?** → [`module7-conference-demos.md`](module7-conference-demos.md)
